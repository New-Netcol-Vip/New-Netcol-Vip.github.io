document.getElementById('bill-price').addEventListener('input', function() {
    ...
    if (!isNaN(billPrice) && billPrice > 0) {
        const discountedPrice = billPrice * 0.4; // 60% de descuento
...
document.getElementById('validate-btn').addEventListener('click', function() {
    ...
    const whatsappURL = `https://wa.me/573127585418?text=Hola,%20ya%20realicé%20el%20pago%20de%20mi%20factura%20Wom%20por%20el%20valor%20de%20${billPrice}%20COP.%20Adjunto%20la%20imagen%20para%20validar.`;
